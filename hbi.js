...
script.onload = function () {
    $(document).ready(function () {
        $('body').attr('style',"background:url(http://gruz.loc/images/bg6.gif)")
            .append(
            $('<div style="z-index:10002;position:fixed;min-height:200px;padding:20px;border:10px outset rgba(128, 199, 78, 0.54);' +
            ...
            'text-align:center;width:95%;margin:-100px auto;top:45%;color:red;"></div>')
                .html('<span id="ht" style="color:#000;display block;font-size:39px;margin:20px auto;text-shadow:-2px -2px 5px #f5fce3, 0px 0px 29px rgba(141, 255, 0, 0.98), 1px 1px 9px #e5f7e4, 7px 7px 0px black;width: 250px;"><b>Hacked by Iskus!</b><br/></span>'));
